                        ...
                        <div className="px-3 py-2 border-bottom mb-3">
                            <div className="container d-flex flex-wrap justify-content-center">
                                <form className="col-12 col-lg-auto mb-2 mb-lg-0 me-lg-auto" onSubmit={handleSearch} noValidate>
                                    <input type="search" className="form-control" placeholder="Search..." aria-label="Search" name="search" value={search} required onChange={e => setSearch(e.target.value)} />
                                </form>

                                <div className="text-end">
                                    <a href="/Account" className="btn btn-primary" role="button">Sign in/Register</a>
                                </div>
                            </div>
                        </div>
                    </header>
